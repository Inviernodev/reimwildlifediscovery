...
public class binOrganic : MonoBehaviour
{
    [SerializeField]
    ...
    {
        if (other.gameObject.name == "Comida(Clone)")
        {
    ...
    public IEnumerator PostAdd(Respuesta5 respueston)
    {
